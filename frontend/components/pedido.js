...
/**
 * Componente: CompPedido
 * Finalidade: Interface principal de vendas (Ponto de Venda).
 * Funcionalidades: Busca de produtos, seleção de cliente, gestão de carrinho e fechamento de pedido.
 */
const CompPedido = {
    /**
     * Props: Centraliza o estado vindo do app.js.
     * Inclui listas de produtos/clientes, dados do carrinho e variáveis de controle de UI.
     */
    props: ['produtos', 'clientes', 'carrinho', 'filtro', 'totalCarrinho', 'selectedCustomerId'],

    /**Template: Dividido em duas colunas (Catálogo e Checkout) utilizando o sistema de grid do Bootstrap.*/
    template: `
    <div class="row">
